...
[ compiledBytecode, realBytecode ].forEach((bytecode, index) => {
    describe("HelpMeSave " + [ "You Think", "For Real" ][ index ], function() {
        // Keep value in the scope
        const copyBytecode = bytecode;
        ...
        before("should replace the bytecode", function() {
            HelpMeSave.unlinked_binary = copyBytecode;
        });
